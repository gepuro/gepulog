...
;
  ...
  .append("svg:clipPath")
    ...
    .append("svg:path")
      .attr("d", " M22.41,5 L 115 5 115 59.12 22.41 59.12 z");g.attr("clip-path", "url(#" + parent_id + "_clippath0)");
        (function (g) {
          g.attr("class", "guide background")
           ...
           .attr("opacity", 1.00);
          g.append("svg:path")
             .attr("d", "M22.41,5 L 115 5 115 59.12 22.41 59.12 z");
        }(g.append("g")));
        (function (g) {
          ...
          g.append("svg:path")
             .attr("d", "M22.41,-13.89 L 115 -13.89");
          g.append("svg:path")
             .attr("d", "M22.41,78.01 L 115 78.01");
          g.append("svg:path")
             .attr("d", "M22.41,-24.1 L 115 -24.1");
          g.append("svg:path")
             .attr("d", "M22.41,98.44 L 115 98.44");
          g.append("svg:path")
             .attr("d", "M22.41,88.23 L 115 88.23");
          g.append("svg:path")
             .attr("d", "M22.41,47.38 L 115 47.38");
          g.append("svg:path")
             .attr("d", "M22.41,57.59 L 115 57.59");
          g.append("svg:path")
             .attr("d", "M22.41,-44.53 L 115 -44.53");
          g.append("svg:path")
             .attr("d", "M22.41,118.86 L 115 118.86");
          g.append("svg:path")
             .attr("d", "M22.41,67.8 L 115 67.8");
          g.append("svg:path")
             .attr("d", "M22.41,-54.74 L 115 -54.74");
          g.append("svg:path")
             .attr("d", "M22.41,26.96 L 115 26.96");
          g.append("svg:path")
             .attr("d", "M22.41,-3.68 L 115 -3.68");
          g.append("svg:path")
             .attr("d", "M22.41,16.74 L 115 16.74");
          g.append("svg:path")
             .attr("d", "M22.41,108.65 L 115 108.65");
          g.append("svg:path")
             .attr("d", "M22.41,37.17 L 115 37.17");
          g.append("svg:path")
             .attr("d", "M22.41,-34.32 L 115 -34.32");
          g.append("svg:path")
             .attr("d", "M22.41,6.53 L 115 6.53");
        }(g.append("g")));
        (function (g) {
          g.attr("stroke", "#F0F0F3")
           .attr("stroke-width", 0.2)
          ...
          g.append("svg:path")
             .attr("d", "M-18.65,5 L -18.65 59.12");
          g.append("svg:path")
             .attr("d", "M156.06,5 L 156.06 59.12");
          g.append("svg:path")
             .attr("d", "M199.73,5 L 199.73 59.12");
          g.append("svg:path")
             .attr("d", "M-62.33,5 L -62.33 59.12");
          g.append("svg:path")
             .attr("d", "M25.03,5 L 25.03 59.12");
          g.append("svg:path")
             .attr("d", "M68.7,5 L 68.7 59.12");
          g.append("svg:path")
             .attr("d", "M243.41,5 L 243.41 59.12");
          g.append("svg:path")
             .attr("d", "M-106,5 L -106 59.12");
          g.append("svg:path")
             .attr("d", "M112.38,5 L 112.38 59.12");
        }(g.append("g")));
      }(g.append("g")));
      (function (g) {
        d3.select("defs")
  .append("svg:clipPath")
    ...
    .append("svg:path")
      .attr("d", " M22.41,5 L 115 5 115 59.12 22.41 59.12 z");g.attr("clip-path", "url(#" + parent_id + "_clippath1)");
        (function (g) {
...
;
  ...
  .append("svg:clipPath")
    ...
    .append("svg:path")
      .attr("d", " M22.41,5 L 115 5 115 59.12 22.41 59.12 z");g.attr("clip-path", "url(#" + parent_id + "_clippath2)");
        (function (g) {
          g.attr("stroke", "none")
...
var data = [
  [45.382136890148615,41.89123189477674,84.63967162846403,100.02825332953795,29.37815154016231,110.44031804671836,70.48077828533859,81.21385032982603,76.20216724990291,27.06711967300111],
  [37.46763372852971,50.570136393290824,34.95684655424409,45.49978889144354,44.9856718202651,45.86228201340756,10.676372012249537,20.872311173809035,17.2573681892331,8.856552348264529]];
...
julia> draw(PNG("~/myplot.png", 4inch, 4inch), myplot)
ERROR: Cairo must be installed to use the PNG backend.
 in PNG at /home/dedicatus545/.julia/v0.3/Compose/src/Compose.jl:59
~~~
とすれば良いはずだが、動かなかった。
解決策が分かったら、報告します。
